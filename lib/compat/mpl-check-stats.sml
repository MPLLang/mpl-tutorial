...
struct
  ...
  fun report () =
    ...
    in
      ...
      p "de-checks" (LargeInt.toString o MPL.GC.numberDisentanglementChecks);
      p "e-detects" (LargeInt.toString o MPL.GC.numberEntanglementsDetected);
      p "max-fork-depth" (Int.toString o ForkJoin.maxForkDepthSoFar)
    end
